...
run_ci() {
  ...
  # python manage.py lintmigrations --exclude-apps=axes --warnings-as-errors --exclude-migration-tests=CREATE_INDEX

  # Checking if all the dependencies are secure and do not have any
  # known vulnerabilities:
  # safety check --full-report -i 40291 -i 42559 -i 42218 -i 44715 -i 44741 -i 45356 -i 44742 -i 44487 -i 44844 -i 47025 -i 43041 -i 48041 -i 48040 -i 44426 -i 44427 -i 44423
